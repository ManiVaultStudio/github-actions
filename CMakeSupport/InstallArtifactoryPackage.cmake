...
set(CMAKESUPPORT_DIR "${CMAKE_CURRENT_LIST_DIR}")
...
macro(get_artifactory_package
    ...
    if(is_combined_package)
        ...
        configure_file(${CMAKESUPPORT_DIR}/aql_multi.json.in ${PROJECT_BINARY_DIR}/aql.json)
        ...
        configure_file(${CMAKESUPPORT_DIR}/aql_single.json.in ${PROJECT_BINARY_DIR}/aql.json)
        # set(AQL_FILE "")
