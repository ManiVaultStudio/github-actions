...
macro(get_artifactory_package
    ...
    if(is_combined_package)
        ...
        file(DOWNLOAD ${package_url} ${DOWNLOADED_FILE} HTTPHEADER "X-Jfrog-Art-Api:${APIREADTOKEN}")
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} -E tar xvf ${DOWNLOADED_FILE} WORKING_DIRECTORY ${EXTRACT_TO_DIR})
    else()
